                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                   <?php if($check == TRUE): ?>
                                   <!-- form -->
                                   <form role="form" method="POST" id="form-porto" action="<?php echo site_url('sk-admin/product/save');?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-xs-12">
                                                ...
                                                <?php 
                                                    ...
                                                    echo '<p class="text-primary"><a href="'.site_url('sk-admin/product/change-picture/'.$porto_id).'" data-toggle="tooltip" data-placement="top" title="change picture">'.$picture.' </a></p>';
                                                    echo '</div>';
                                                endif; ?>
                                                <div class="form-group">
        ...
        success: function (data) {
            if(data.status == false){
                ...
                if(data.load == 0){
                    ...
                    var url = "<?php echo site_url('sk-admin/product');?>";
