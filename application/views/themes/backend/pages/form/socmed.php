                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Form Social Media</h3>
                                ...
                                <div class="box-body">
                                   <?php if($check == TRUE): ?>
                                   <!-- form -->
                                   <form role="form" method="POST" id="form-socmed" action="<?php echo site_url('sk-admin/socmed/save');?>">
        ...
        success: function (data) {
           if(data.status == false){
                ...
                if(data.load == 0){
                    ...
                    var url = "<?php echo site_url('sk-admin/socmed');?>";
