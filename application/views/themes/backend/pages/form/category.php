                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                   <?php if($check == TRUE): ?>
                                   <!-- form -->
                                   <form role="form" method="POST" id="form-category" action="<?php echo site_url('sk-admin/category/save');?>">
        ...
        success: function (data) {
           if(data.status == false){
                ...
                if(data.load == 0){
                    ...
                    var url = "<?php echo site_url('sk-admin/category');?>";
...
function clearNotif()
{
    $("#success-form-category").html("");
    $("#success-form-category").slideUp("fast");
}
</script>