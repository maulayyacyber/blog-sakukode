                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            ...
                                            <div class="table-responsive"> 
                                                <a href="<?php echo site_url('sk-admin/contact/reply/'.$data->message_id);?>" class="btn btn-success btn-flat"> Reply</a>
                                                &nbsp;&nbsp;&nbsp;
                                                <a href="#" id="<?php echo $data->message_id;?>" class="btn btn-danger btn-flat  btn-delete"> Delete</a>
                                            </div>
                                            <?php 
                                            else:
                    ...
                    $(document).ready(function() {
                        $('.btn-delete').click(function(e) {
                            ...
                            function(){
                                   ...
                                   $.ajax({
                                   type: "GET",
                                   url: "<?php echo site_url('sk-admin/contact/delete_message');?>",
                                   dataType : "json",
                                   data: "id="+id,
