                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="#" id="mark-read">Mark as read</a></li>
                                                            <li><a href="#" id="mark-unread">Mark as unread</a></li>
                                                            <li class="divider"></li>
                                                            <li><a href="#" id="move-trash">Move to trash</a></li>
                                                            <li class="divider"></li>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#delete-all').click(function(e) {
            ...
            function(isConfirm){
                ...
                if(isConfirm) {
                    ...
                    if(idArray != ''){
                        $.post("<?php echo site_url('sk-admin/contact/delete_many_message');?>",{data:idArray},function(data){
                        if(data.status == true)
                        {
                            location.reload();
                        }
        ...
        $('#move-trash').click(function(e) {
                ...
                if(idArray != ''){
                    $.post("<?php echo site_url('sk-admin/contact/move_trash');?>",{data:idArray},function(data){
                    if(data.status == true)
                    {
                        location.reload();
                    }    
        ...
        $('#mark-read').click(function(e) {
                ...
                if(idArray != ''){
                    $.post("<?php echo site_url('sk-admin/contact/mark_read');?>",{data:idArray},function(data){
                    if(data.status == true)
                    {
                        location.reload();
                    }    
        ...
        $('#mark-unread').click(function(e) {
                ...
                if(idArray != ''){
                    $.post("<?php echo site_url('sk-admin/contact/mark_unread');?>",{data:idArray},function(data){
                    if(data.status == true)
                    {
                        location.reload();
                    }    
